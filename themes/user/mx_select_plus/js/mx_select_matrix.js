(function($) {
	...
	var onDisplay = function(cell){
		...
		var $select = $('select', cell.dom.$td),
			...
			$select.chosen({add_new_options: add_new_options , add_new: cell.field.id, cell_obj: cell, allow_single_deselect: allow_deselect, group_class: "."+ cell.field.id +"_" +cell.col.id, callback: function() {}});
